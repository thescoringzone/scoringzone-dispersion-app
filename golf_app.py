...
# --- 4. SINGLE-PAGE PDF ENGINE (WITH TO PAR) ---
...
# --- PAGE: RECORD ---
    ...
    if not t_df.empty:
        st.download_button("📄 Download 1-Page Tournament Report", data=create_one_page_pdf(t_df, f"Report: {st.session_state.active_t}"), file_name=f"{st.session_state.active_t}_report.pdf")
...
# --- PAGE: STATS ---
    ...
    if not st.session_state.data.empty:
        st.download_button("📄 Download 1-Page Master Report", data=create_one_page_pdf(st.session_state.data, "Master Performance Report"), file_name="master_report.pdf")
